...
const SubjectListPage = () => {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      case 'บังคับ': return 'bg-blue-100 text-blue-700 border border-blue-300';
      case 'บังคับเลือก': return 'bg-red-100 text-red-700 border border-red-300';
      case 'เลือกเฉพาะสาขา': return 'bg-yellow-100 text-yellow-700 border border-yellow-300';
