...
function CEGPTPage() {
  ...
  const { loading, result, error, extractText, reset: resetOCR } = useOCR()
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 flex flex-col overflow-hidden bg-gradient-to-br from-blue-50 via-white to-orange-50">
